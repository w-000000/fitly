...
public class RecommendationRequest {
    ...
    public RecommendationRequest(Long customerId, String tpo, String preferredStyle, String wardrobeDescription, String wardrobeImageUrl) {
        ...
        this.status = Status.COMPLETED; this.matchScore = 96;
    ...
    public String getWardrobeDescription() { return wardrobeDescription; }
    public String getWardrobeImageUrl() { return wardrobeImageUrl; }
    public Status getStatus() { return status; }
    public int getMatchScore() { return matchScore; }
    public String getStylingComment() { return stylingComment; }
